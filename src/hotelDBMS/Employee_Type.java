...
public class Employee_Type {
	...
	public static void readFromTable(int infonum){
		...
		String sqlDB = "SELECT TOP "+infonum+" * FROM Employee_Type";
		...
		try {
			...
			if (m.next()) {
				...
				do {
					...
					System.out.println("employee_type_name :" + m.getString(2));
	...
	public static void getById(){
		...
		String sqlDB = "SELECT * FROM Employee_Type where id="+id;
		Connection conn = null;
		try {
			Driver driver = (Driver) Class.forName("com.microsoft.sqlserver.jdbc.SQLServerDriver").newInstance();
			DriverManager.registerDriver(driver);
	...
	try {
	    ...
	    String sqlDBss = "update Employee_Type set is_Active = 'false' where id<="+id;
	...
	String sqlDB = "SELECT TOP 10 * FROM Employee_Type";
	...
	public static void deleteById() {
		...
		System.out.println(" Enter id to be deleted ?");
		  int id = scanner.nextInt();
		String sqlDB = "delete from Employee_Type where id ="+id;
		Connection conn = null;
	try {
		Driver driver = (Driver) Class.forName("com.microsoft.sqlserver.jdbc.SQLServerDriver").newInstance();
		DriverManager.registerDriver(driver);
	...
	public static void makeIsActiveFalseById(int id) {
		...
		try {
			...
			String user = "sa";
			String pass = "root";
		    String sqlDBss = "update Employee_Type set is_Active = 'true' where id<="+id;
	...
	try {
		...
		String sqlDBss = "INSERT INTO Employee_Type VALUES(" + i+numberToAdd + ",'"+ (employee_type_name[i]) +"','"+ created_date + "','"+updated_date+"','"+is_Active+"')";
