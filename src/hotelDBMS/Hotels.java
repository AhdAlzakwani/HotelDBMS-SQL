...
public static void readFromTable(int infonum){
	...
	String sqlDB = "SELECT TOP "+infonum+" * FROM Hotels";
...
try {
    ...
    String sqlDBss = "update Hotels set is_Active = 'false' where id<="+id;
...
public static void deleteById() {
	...
	System.out.println(" Enter id to be deleted ?");
	  int id = scanner.nextInt();
	String sqlDB = "delete from Hotels where id ="+id;
	Connection conn = null;
try {
	Driver driver = (Driver) Class.forName("com.microsoft.sqlserver.jdbc.SQLServerDriver").newInstance();
	DriverManager.registerDriver(driver);
...
public static void makeIsActiveFalseById(int id) {
	...
	try {
		...
		String user = "sa";
		String pass = "root";
	    String sqlDBss = "update Hotels set is_Active = 'true' where id<="+id;
