...
public class Employees {
	...
	public static void readFromTable(int infonum){
		...
		String sqlDB = "SELECT TOP "+infonum+" * FROM Employees";
		...
		try {
			...
			if (m.next()) {
				...
				do {
					...
					System.out.println("employee_type_id : " + m.getInt(2));
					System.out.println("room_id : " + m.getInt(3));
	...
	public static void getById(){
		...
		String sqlDB = "SELECT * FROM Employees where id="+id;
		Connection conn = null;
		try {
			Driver driver = (Driver) Class.forName("com.microsoft.sqlserver.jdbc.SQLServerDriver").newInstance();
			DriverManager.registerDriver(driver);
	...
	try {
	    ...
	    String sqlDBss = "update Employees set is_Active = 'false' where id<="+id;
	...
	String sqlDB = "SELECT TOP 10 * FROM Employees";
	...
	public static void deleteById() {
		...
		System.out.println(" Enter id to be deleted ?");
		  int id = scanner.nextInt();
		String sqlDB = "delete from Employees where id ="+id;
		Connection conn = null;
	try {
		Driver driver = (Driver) Class.forName("com.microsoft.sqlserver.jdbc.SQLServerDriver").newInstance();
		DriverManager.registerDriver(driver);
	...
	public static void makeIsActiveFalseById(int id) {
		...
		try {
			...
			String user = "sa";
			String pass = "root";
		    String sqlDBss = "update Employees set is_Active = 'true' where id<="+id;
	...
	try {
		...
		Integer numberToAdd = rn.nextInt(10);
		  for(int i = 1; i<=number; i++ ) {
			  String employeesql = "(SELECT id FROM Employee_Type)";
			  String roomsql = "(SELECT id FROM Room)";
			  
		String sqlDBss = "INSERT INTO Employees VALUES(" + i+numberToAdd + "," + employeesql + ","+roomsql+",'"
